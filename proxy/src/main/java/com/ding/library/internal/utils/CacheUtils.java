...
public class CacheUtils {
    ...
    private List<ICacheListener> listenerList = new ArrayList<>();
    ...
    public void cleanCache() {
        ...
        if (!listenerList.isEmpty()) {
            for (ICacheListener listener : listenerList) {
                listener.onClear();
            }
        }
    }

    public void addObserver(@NonNull ICacheListener listener) {
        listenerList.add(listener);
    }

    public void removeObserver(@NonNull ICacheListener listener) {
